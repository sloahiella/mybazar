...
export default function FlashSale() {
  ...
  useEffect(() => {
    async function loadFlashProducts() {
      // ডাটাবেজ থেকে পণ্য ফ্ল্যাশ সেলে দেখানোর জন্য রিড
    ...
    <div className="w-full bg-gradient-to-r from-pink-500 to-pink-600 py-4 px-4 my-4 rounded-2xl shadow-md max-w-7xl mx-auto box-border">
      <div className="flex justify-between items-center mb-3 text-white">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-bold m-0">আজকের ধামাকা ফ্ল্যাশ সেলে</h3>
        </div>
      ...
      <div className="flex gap-4 overflow-x-auto no-scrollbar pb-1">
        {flashProducts.map((prod) => (
          /* 👑 এখানে ওপেনিং আর ক্লোজিং ট্যাগ দুটোই পারফেক্টলি <div> করে দেওয়া হয়েছে */
